            ...
            <div class="row">
                <div class="col-lg-6 text-center animate__animated animate__fadeInLeft">
                    <div class="image-container">
                        <img src="{{ asset('front/img/gambar.jpg') }}" alt="Gambar 1" class="img-fluid w-100" style="height: 300px">
                ...
                <div class="col-lg-6 text-center animate__animated animate__fadeInRight">
                    <div class="image-container">
                        <img src="{{ asset('front/img/gambar.jpg') }}" alt="Gambar 2" class="img-fluid w-100" style="height: 300px">
                        <div class="image-overlay">
                            <div class="overlay-content">
                                <h3 class="overlay-title text-warning">Teknologi Pertanian Terkini</h3>
                                <p class="overlay-description">Kami menyediakan informasi terbaru mengenai teknik pertanian dan penggunaan pupuk.</p>
                            </div>
                        </div>
                    </div>
                </div>
