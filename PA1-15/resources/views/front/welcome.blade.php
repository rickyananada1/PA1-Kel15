...
<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col-md-4">
            <div class="info-card">
                <img src="{{ asset('front/img/peningkatan.jpg') }}" alt="Farming 1">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="info-card">
                <img src="{{ asset('front/img/pengendalian.jpg') }}" alt="Farming 2">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="info-card">
                <img src="{{ asset('front/img/teknologi.jpg') }}" alt="Farming 3">
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="text-left text-dark">
                ...
                <p>Di Indonesia pada saat panen, hasil pertanian petani seperti sayur-sayuran, buah-buahan, umbi-umbian
                    dan sereal, banyak mengalami kerusakan sebelum dikonsumsi. Hal ini dikarenakan hasil panen yang
                    ...
                    sekitar 30 – 40 % ). Hal ini juga menyebabkan hasil penjualan dari hasil pertanian tersebut tidak
                    maksimal.
                </p>
        ...
        <div class="col-md-6">
            <div class="text-left text-dark">
                ...
                <p>
                    Pupuk organik dari limbah pertanian banyak dijadikan bahan pembicaraan hampir disemua
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d63777.295704003984!2d99.1926741!3d2.4801401!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x303201d908a47355%3A0x53d7644c1ab82e10!2sPangombusan%2C%20Kec.%20Parmaksian%2C%20Toba%2C%20Sumatera%20Utara!5e0!3m2!1sid!2sid!4v1686146184884!5m2!1sid!2sid" allowfullscreen="" width="100%" height="400px" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                </div>
            </div>
