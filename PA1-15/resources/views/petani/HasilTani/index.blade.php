        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="/petani/hasiltani/{{ $item->id }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <a href="/petani/hasiltani/{{ $item->id }}" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i></a>
                    <a href="/petani/hasiltani/{{ $item->id }}/edit" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
